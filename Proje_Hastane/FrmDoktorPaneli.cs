...
namespace Proje_Hastane
{
    public partial class FrmDoktorPaneli : Form
    {
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            MessageBox.Show("Doctors Added . ","İnformation ! . ",MessageBoxButtons.OK,MessageBoxIcon.Warning);
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Doctor Deleted . ","Uyari",MessageBoxButtons.OK,MessageBoxIcon.Warning);
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Doctors Updated . . ", "İnformation ! . ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
    }
}
